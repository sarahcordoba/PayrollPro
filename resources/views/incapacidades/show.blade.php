...
/** @var \App\Models\User $user */ // <-- This PHPDoc hint is for Intelephense
    ...
    $allow=$user->hasAnyRole(['rrhh','admin']) && $user->empleado->id != $incapacidad->empleado->id;
    @endphp
            ...
            <div class="card-body text-center">
                ...
                <div class="card mb-3">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item"><strong>Tipo de Incapacidad:</strong>
                            {{ $incapacidad->tipo_incapacidad ? ($tiposIncapacidad[$incapacidad->tipo_incapacidad] ?? $incapacidad->tipo_incapacidad) : 'No aplica' }}
                        </li>
                    </ul>
                </div>
